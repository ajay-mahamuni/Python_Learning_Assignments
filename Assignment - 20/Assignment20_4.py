...
def main():
    if len(sys.argv) == 2:
        if sys.argv[1] == "--h" or sys.argv[1] == "--H":
            ...
            print("Time taken by script to delete duplicate files : ",end_time - start_time)
...
if __name__ == "__main__":
    ...
    # D:\ajay.mahamuni\Python-2025\Programs\Python_Learning_Assignments\Assignment - 20>python Assignment20_4.py Marvellous
    # Total deleted files :  8
    # Log file for deleted Duplicate files with names :  MarvellousLog22062025-0100.log  is created.
    # Start time :  2025-06-22 01:00:04.387493
    # End time :  2025-06-22 01:00:04.394927
    # Time taken by script to delete duplicate files :  0:00:00.007434