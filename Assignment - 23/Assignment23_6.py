#Assignment 23 - Problem 6 - Python Machine learning basics
...
def LoadDataFrame(data):
    ...
    print("Sorted data of dataframe is : \n", sortedDataframe)
...
if __name__ == "__main__":
    ...
    # D:\ajay.mahamuni\Python-2025\Programs\Python_Learning_Assignments\Assignment - 23>python Assignment23_6.py
    # ------------------------------------------------------------------------------------------------------------------------
