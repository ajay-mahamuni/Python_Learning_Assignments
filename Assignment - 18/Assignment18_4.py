#Assignment 18 - Problem 4 - Python file i/o imlpmentation
...
if __name__ == "__main__":
    ...
    # D:\ajay.mahamuni\Python-2025\Programs\Python_Learning_Assignments\Assignment - 18>python Assignment18_4.py Demo.txt Demo-13062025-234416.txt
    # Content of both files are same..

    # D:\ajay.mahamuni\Python-2025\Programs\Python_Learning_Assignments\Assignment - 18>python Assignment18_4.py Demo.txt Assignment18_1.py
    # Content of both files are not same..

    # D:\ajay.mahamuni\Python-2025\Programs\Python_Learning_Assignments\Assignment - 18>python Assignment18_4.py Demo.txt
