#Assignment 18 - Problem 3 - Python file i/o imlpmentation
...
if __name__ == "__main__":
    ...
    # D:\ajay.mahamuni\Python-2025\Programs\Python_Learning_Assignments\Assignment - 18>python Assignment18_3.py Demo.txt
    # New file created with name :  Demo-13062025-234416.txt

    # D:\ajay.mahamuni\Python-2025\Programs\Python_Learning_Assignments\Assignment - 18>python Assignment18_3.py Hello.txt
